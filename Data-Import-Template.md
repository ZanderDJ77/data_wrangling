...
Import the dataset using an absolute path. But relative paths are much
stronger because they do not change if the files are moved around on
your computer.
...
You can use ‘View’ for the entire dataset. Better to use separately in a
consoline line command and not knit into an R Markdown file
